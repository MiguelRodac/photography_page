...
@Component({
  ...
  template: `
    <a [href]="whatsappLink"
       ...
       class="fixed bottom-6 right-6 z-50 w-14 h-14 flex items-center justify-center rounded-full bg-green-500 text-white shadow-lg hover:shadow-green-500/40 hover:scale-110 transition-all duration-300 group"
...
export class WhatsAppButtonComponent implements OnInit {
  ...
  readonly tooltip = signal('¿Hablamos?');
  readonly ariaLabel = signal('Contactar por WhatsApp');
